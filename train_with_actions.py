...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "see the `filter_overlaps` argument in `RawTokenDatasetObsAction` for details.")
        ,
    )
...
def main():
    ...
    train_dataset = RawTokenDatasetObsAction(args.train_data_dir, window_size=args.window_size,
                                    stride=args.stride, filter_overlaps=args.filter_overlaps)
    if not args.overfit_first_batch:
        eval_dataset = RawTokenDatasetObsAction(args.val_data_dir, window_size=args.window_size,
